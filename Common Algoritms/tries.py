class TrieNode:
    # IMPORTANT: You need to define an init function and not just add variables to the class. Otherwise all instantiations of
    # TrieNode will share the same variable state.
    def __init__(self):
